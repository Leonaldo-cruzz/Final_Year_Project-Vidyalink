...
class VerificationService {
  isPortfolioVerified(portfolio) {
    if (!portfolio || !portfolio.verifiedBy || !portfolio.verificationHash) return false;

    const explicitStatus = portfolio.verificationStatus || portfolio.status;
    return !explicitStatus || normalizeVerificationStatus(explicitStatus) === 'VERIFIED';
  }
