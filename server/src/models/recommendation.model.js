...
const recommendationSchema = new mongoose.Schema(
  {
    ...
    type: { type: String, enum: RECOMMENDATION_TYPES, required: true, immutable: true },
    targetId: { type: String, required: true, trim: true, maxlength: 200, immutable: true },
    ...
    status: { type: String, enum: RECOMMENDATION_STATUSES, default: 'ACTIVE', required: true },
    algorithmVersion: { type: String, required: true, trim: true, maxlength: 30 },
