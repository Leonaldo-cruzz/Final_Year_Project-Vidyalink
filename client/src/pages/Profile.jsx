...
import { z } from 'zod';
import { Save, Edit2, CheckCircle2, AlertCircle, UserCircle, Globe, Link as LinkIcon } from 'lucide-react';
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-semibold text-slate-300 uppercase tracking-widest mb-2">
                      <GithubIcon className="w-3.5 h-3.5 inline mr-1" />GitHub URL
                    </label>
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-slate-300 uppercase tracking-widest mb-2">
                      <LinkedinIcon className="w-3.5 h-3.5 inline mr-1" />LinkedIn URL
                    </label>
