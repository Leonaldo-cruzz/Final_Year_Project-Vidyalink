...
def analyze_formatting(
    ...
    # 1. Text Parseability & Document Length (up to 25 pts)
    # Recommended ATS resume length is 200-1200 words
    ...
    # 2. Standard Section Headers (up to 30 pts)
    ...
    # 3. Essential Contact Information (up to 25 pts)
    ...
    # 4. Encoding Health & Hygiene (up to 20 pts)
    # Check for excessive broken unicode replacement characters or repetitive symbols
