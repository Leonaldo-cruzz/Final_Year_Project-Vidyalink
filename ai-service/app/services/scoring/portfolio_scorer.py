...
Applies exact weights, generates explainable dimensional breakdown,
classifies score category, and returns the versioned evaluation result.
"""
...
def evaluate_portfolio_score(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # Compute scores across all 6 dimensions
